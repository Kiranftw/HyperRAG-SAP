...
LOGGER.info(f"Model {ollama_model_name} initialized. Keep-alive set to infinite. Duration: {init_duration:.2f}s")
...
try:
    ...
    LOGGER.info(f"Generation finished. TTFT: {ttft:.2f}s | Total: {total_gen_time:.2f}s")
